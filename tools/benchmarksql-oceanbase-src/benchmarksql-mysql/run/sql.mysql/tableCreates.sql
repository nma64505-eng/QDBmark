...
create tablegroup tpcc_group binding true partition by hash partitions 96;
...
) TABLE_MODE='QUEUING' tablegroup=tpcc_group partition by hash(no_w_id) partitions 96;
...
create table bmsql_item (
  ...
  i_im_id  integer,
  PRIMARY KEY (i_id)
) locality='F,R{all_server}@z1, F,R{all_server}@z2, F,R{all_server}@z3' primary_zone='z1'  duplicate_scope='cluster';
